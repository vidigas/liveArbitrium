...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        case 'BITFINEX_SET_PRICING_LTCBTC':
            return { ...state, LTCBTC: action.payload };
        case 'BITFINEX_SET_PRICING_ETHBTC':
            return { ...state, ETHBTC: action.payload };
        case 'BITFINEX_SET_PRICING_XRPBTC':
            return { ...state, XRPBTC: action.payload };
        case 'BITFINEX_SET_PRICING_XMRBTC':
            return { ...state, XMRBTC: action.payload };
        case 'BITFINEX_SET_PRICING_DASHBTC':
